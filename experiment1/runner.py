...
from dkm import MemoryWriterDKM
from vbm import MemoryWriterVBM
...
class Runner:
    ...
    def run(self, with_info=False):
        ...
        DKM_qW, DKM_qM = self.DKM.write_episode(Z=Z, pM=self.pM)
...
if __name__ == '__main__':
    ...
    if mode == 'simple':
        r = Runner(T=1, K=32, C=200, sigma2_w=0.3, R0_init_scale=0.05, opt_iters=1)
        ...
        id = str(uuid.uuid4())
        fn = 'heatmap_elboratio_kc_t{}_o{}_R0initscale{}pt{}_id{}.png'.format(T, opt_iters, R0scale_int, R0scale_decimal, id)
