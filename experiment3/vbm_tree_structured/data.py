...
def get_dataset(name, hps):
    ...
    ds_train = preprocess_dataset(name, ds_train, hps, is_train=True)
    ds_val = preprocess_dataset(name, ds_val, hps, is_train=False)
    ds_test = preprocess_dataset(name, ds_test, hps, is_train=False)

    return ds_train, ds_val, ds_test


def preprocess_dataset(name, dataset, hps, is_train):
